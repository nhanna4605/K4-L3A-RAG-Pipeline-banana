...
| Pipeline Evaluation & Golden Dataset | Trực tiếp đóng góp 5 câu hỏi vàng, chạy A/B testing so sánh phương pháp Dense-only với Hybrid + RRF, lập báo cáo kết quả. | `group_project/evaluation/RESULT.md` | Done |
